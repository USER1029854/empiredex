# Pair contract — FF/WBNB (BNB Smart Chain (Binance))

- **Address:** `0x3D213903AE906A061703a4e363162cb35899A39E`
- **Chain:** BNB Smart Chain (Binance)
- **Explorer:** https://bscscan.com/address/0x3D213903AE906A061703a4e363162cb35899A39E
...
|---|---|---|---|
| token0 | FF `0x6460D09165C8E25a44E4Fa487171f6613e93aBD3` | `103812886817585414011` | 103.812887 |
| token1 | WBNB `0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c` | `33737559477856991795` | 33.737559 |

- **LP total supply:** 58.993615 EMP-LP
- **Estimated USD value held:** **$41,079.16**
- **Pricing method:** est-2x-token1 (WBNB priced; FF unpriced by DefiLlama) — DefiLlama's own coins API (`coins.llama.fi/prices/current`) does not carry a price for the DEX-issued / bridged side of this pool, so USD value is estimated as 2× the priced side, which is exactly the convention DefiLlama's own `getUniTVL` helper uses for Uniswap-V2-style forks (this pricing methodology was validated: summing this same calculation across all 143 enumerated pairs on all 8 reachable chains reproduces 99.70% of DefiLlama's reported total protocol TVL — see the main README's Coverage Quantification section).
...
FF is a third-party token that used EmpireDEX's permissionless pair-creation/listing feature; it is not an EmpireDEX-issued asset. Neither the pair address nor the FF token is independently verified on an explorer accessible to this review; decompiled with heimdall.
