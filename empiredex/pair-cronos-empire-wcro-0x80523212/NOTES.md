# Pair contract — EMPIRE/WCRO (Cronos)

- **Address:** `0x80523212e85e7FD850c85CC804263Ad421696d87`
- **Chain:** Cronos
- **Explorer:** https://cronoscan.com/address/0x80523212e85e7FD850c85CC804263Ad421696d87
...
This is Cronos's official CRODEX-family launch pair per EmpireDEX docs (docs list this exact pair address as 'CRODEX/CRO'); the token0 contract's on-chain symbol() is 'EMPIRE', not 'CRODEX'. No free Cronos explorer API is available; decompiled with heimdall.
