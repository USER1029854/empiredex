# Pair contract — WCRO/ROOT (Cronos)

- **Address:** `0xe5F1463660cC2464F69C64a54b67f5957c95fcbd`
- **Chain:** Cronos
- **Explorer:** https://cronoscan.com/address/0xe5F1463660cC2464F69C64a54b67f5957c95fcbd
...
|---|---|---|---|
| token0 | WCRO `0x5C7F8A570d578ED84E63fdFA7b1eE72dEae1AE23` | `916531501985798042397564` | 916,531.501986 |
| token1 | ROOT `0xF2F9889e797d2AAddc234f4f3027C62c28165af4` | `82340729293153148145` | 82.340729 |

- **LP total supply:** 8,614.649337 EMP-LP
- **Estimated USD value held:** **$85,492.25**
- **Pricing method:** est-2x-token0 (WCRO priced; ROOT unpriced by DefiLlama) — DefiLlama's own coins API (`coins.llama.fi/prices/current`) does not carry a price for the DEX-issued / bridged side of this pool, so USD value is estimated as 2× the priced side, which is exactly the convention DefiLlama's own `getUniTVL` helper uses for Uniswap-V2-style forks (this pricing methodology was validated: summing this same calculation across all 143 enumerated pairs on all 8 reachable chains reproduces 99.70% of DefiLlama's reported total protocol TVL — see the main README's Coverage Quantification section).
...
Same bridged ROOT token as the BSC pair above (address is identical across BSC and Cronos), paired here against WCRO. No free Cronos explorer API is available; decompiled with heimdall.
